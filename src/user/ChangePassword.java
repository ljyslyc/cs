...
public class ChangePassword {
	public ChangePassword() {
		 ...
		 p.setLayout(null);
			...
			label.setBounds(170, 70, 80, 25);
			p.add(label);
			JPasswordField passwordField = new JPasswordField();
			passwordField.setBounds(255, 70, 120, 21);
			p.add(passwordField);
			
			JLabel label_1 = new JLabel("\u65B0\u5BC6\u7801");
			label_1.setForeground(Color.white);
			label_1.setBounds(170, 120, 80, 25);
			p.add(label_1);
			
			JPasswordField passwordField_1 = new JPasswordField();
			passwordField_1.setBounds(255, 120, 120, 21);
			p.add(passwordField_1);
			
			JLabel label_2 = new JLabel("\u518D\u6B21\u786E\u8BA4\u5BC6\u7801");
			label_2.setForeground(Color.white);
			label_2.setBounds(170, 170, 80, 25);
			p.add(label_2);
			
			JPasswordField passwordField_2 = new JPasswordField();
			passwordField_2.setBounds(255, 170, 120, 21);
			p.add(passwordField_2);
			
			JLabel label_3 = new JLabel("\u7528\u6237\u540D");
			label_3.setForeground(Color.white);
			label_3.setBounds(170, 220, 80, 25);
			p.add(label_3);
			
			JTextArea textArea = new JTextArea();
			textArea.setBounds(255, 220, 120, 21);
			p.add(textArea);
